...
import { FetchWhatsNews } from '../../../../actions/whats-new';

const WhatsNew = () => {
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(FetchWhatsNews(0, 20));
  }, []);
  const whatsNews = useSelector(state => state.whatsNew.whatsNews);
  console.log('WhatsNew => ', whatsNews);
  return (
