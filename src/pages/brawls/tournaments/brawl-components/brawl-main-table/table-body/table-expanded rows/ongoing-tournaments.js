const OngoingTournamentsRow = ({ selectFighter, tournamentStatus }) => {
  return (
              ...
              <div className="col-4 mt-5 pt-3 pl-5">
                <div className="for_centerization mb-3 pl-3">
                  ...
                  <div className="result_chain">
                    ...
                    <div className="looser_main">
                      <a className="btn btn_bg_hk mt-2 looser d-flex justify-content-start waiting_participaters">
                        {" "}
                        <img
...
export default OngoingTournamentsRow;
